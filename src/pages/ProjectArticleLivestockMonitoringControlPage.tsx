...
import { projectArticleLivestockMonitoringControl } from '../content/projectArticleLivestockMonitoringControl';
import '../styles/project-article.css';

export function ProjectArticleLivestockMonitoringControlPage() {
  const { language } = useLanguage();
  const c = projectArticleLivestockMonitoringControl[language];
