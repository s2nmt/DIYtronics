...
import { projectArticleSmartAgricultureIot } from '../content/projectArticleSmartAgricultureIot';
import '../styles/project-article.css';

export function ProjectArticleSmartAgricultureIotPage() {
  const { language } = useLanguage();
  const c = projectArticleSmartAgricultureIot[language];
